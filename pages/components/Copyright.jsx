...
const Copyright = () => {
  ...
  return (
    <m.div variants={parent} initial="initial" animate="animate" className="copyright">
      ...
      <m.span className="move" variants={child}><Link tabIndex={5} scroll={false} href="/imprint">Imprint</Link></m.span>
      <m.span className="move" variants={child}><Link tabIndex={3} scroll={false} href="/about">About</Link></m.span>
